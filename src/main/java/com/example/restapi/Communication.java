...
public class Communication {
    ...
    public List<Employee> getAllEmployees(){
        ...
        // ParameterizedTypeReference вспомогательный клас для передачи дженерик типа
    ...
    public void saveEmployee(Employee employee){
        ...
        if(id==0){
            ResponseEntity<String> responseEntity = restTemplate.postForEntity(URL, employee, String.class); // String == convert to JSON
